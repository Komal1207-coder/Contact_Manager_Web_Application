...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
            <a class="navbar-brand" href="index.jsp"><i class="fa-solid fa-square-phone"></i> ContactManager</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="addCont.jsp"><i class="fa-solid fa-square-plus"></i> Add Contact Details</a>
                    </li>
                ...
                {%>
                   ...
                   <form class="form-inline my-2 my-lg-0">
                    <a href="loginp.jsp" class="btn btn-success"><i class="fa-solid fa-circle-user"></i>Login</a>
                    <a href="registerp.jsp" class="btn btn-danger ml-2"><i class="fa-solid fa-user"></i>Register</a>
                </form>
                <%
                }
                else{%>
